...
if (url.includes('localhost')) {
  console.log('⚠️  Local development detected. CSP is more permissive in development.');
  console.log('   Make sure to test on production deployment for strict CSP validation.');
  console.log('\nTo test CSP:');
...
console.log('6. Add any missing trusted domains to the CSP allowlist in middleware/security-headers.ts');
console.log('\n📋 Current CSP allows:');
console.log('- Scripts: self, nonce, Google Analytics, Supabase, jsdelivr, Sentry, Cloudflare');
console.log('- Styles: self, unsafe-inline, Google Fonts, Fontshare');
console.log('- Images: self, data, https');
console.log('- Connections: self, Supabase, OpenAI, Resend, Google Analytics, Sentry, Cloudflare');
