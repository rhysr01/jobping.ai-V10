export default function LogoWordmark() {
	return (
		<header
			data-testid="logo"
			className="font-display inline-flex items-center gap-2 md:gap-3 font-semibold tracking-tight leading-[1] text-7xl md:text-8xl overflow-visible px-1 pr-3 md:pr-4"
